...
```{r, echo=FALSE, out.width='400px', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/9bed2a15-5e3b-40f8-a1a9-a20ee57b0d8e")
```
...
```
```{r, echo=FALSE, out.width='400px', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/018d1623-7cfe-4579-8373-246fdc87b078")
```
---
...
knitr::include_graphics("https://github.com/user-attachments/assets/b77ed5c0-0021-4189-ae07-c142a17221bd")

```

```{r, echo=FALSE, out.width='45%', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/3bc98573-4c5b-4057-8b21-3db3dfe37c5f")
```
...
```{r, echo=FALSE, out.width='45%', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/2d1bc6b9-70e3-47ea-9d68-9259cb02c849")
```
...
```{r, echo=FALSE, out.width='45%', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/af339a58-beeb-4a84-ae0c-9169e7c2708b")
```

```{r, echo=FALSE, out.width='45%', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/9d99c117-9dc0-475d-a6b8-a8c027b8f758")
```
...
```
```{r, echo=FALSE, out.width='45%', fig.align='center'}
knitr::include_graphics("https://github.com/user-attachments/assets/ca5c1ba8-15e3-4016-9c16-ee112f204128")
```
